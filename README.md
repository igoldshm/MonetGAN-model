...
##### LAMBDA optimization
- We have been expirimenting with different values for the weights of each loss (LAMBDA) to get the best visual outcome. See ![visual quality experimentation]([[experiment-setup-visual-quality.md](https://github.com/igoldshm/MonetGAN-model/blob/main/experiment-setup-visual-quality.md)]) and ![Quantitive evaluation]([Quantitative-evaluation])
#### Discriminator loss
